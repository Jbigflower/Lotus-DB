...
from src.services.sync.memory_sync_service import MemorySyncService
...
class SyncManager:
    def __init__(self):
        ...
        self.memory_sync = MemorySyncService()
